...
import org.jdesktop.application.Application;//vm
import org.jdesktop.application.Task;//vm
...
//                getInstance().getContext().getResourceMap();
        ...
        taskMonitor.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                ...
                if ("started".equals(propertyName)) {
                    ...
                    //vm progressBar.setIndeterminate(true);
    ...
    private class SaveTask extends Task<Object, Void> {
        SaveTask() {
            ...
            super(Application.getInstance(DesktopApplication1.class));
        }
           ...
           progressBar.setVisible(true);
            try {
                for(int i = 0; i < 10; i++) {
                    ...
                    //setMessage(getResourceMap().getString("StatusBar.Working")+"... [" + i + "]"); //vm
                    Thread.sleep(150L);
                    setProgress(i, 0, 9);
