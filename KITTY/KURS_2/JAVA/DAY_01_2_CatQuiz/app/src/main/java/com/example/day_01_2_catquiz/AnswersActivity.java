package com.example.day_01_2_catquiz;
...
public class AnswersActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_ANSWER_IS_TRUE = "ru.alexanderklimov.catquiz.true_answer";
    public static final String EXTRA_ANSWER_INDEX = "ru.alexanderklimov.catquiz.index_answer";
